...
\textit{#2} \\[1em]
\IfBooleanTF#1{\makebox[0.8\textwidth]{\dotfill}}{\makebox[0.4\textwidth]{\dotfill};\makebox[0.4\textwidth]{\dotfill}}
\end{tabular}%
}
...
\textbf{Commitment of the Host Institution for ERC Calls 2027}
\footnotemark[1]$^{,}$\footnotemark[2]$^{,}$\footnotemark[3]
}

\bigskip

\footnotetext[1]{A scanned copy of the signed statement should be uploaded
electronically via the
\href{https://ec.europa.eu/info/funding-tenders/opportunities/portal/screen/home}{
Funding \& Tenders Portal} Submission Service in PDF format.}

\footnotetext[2]{The statement of commitment of the Host Institution refers to most
obligations of the Host Institution, which are stated in the Model Grant Agreement used
for ERC actions (MGA). The
...
is available on the Funding \& Tenders
Portal. The reference to the time commitment of the Principal Investigator is stated in
the ERC Work Programme 2027.}

\footnotetext[3]{This statement (on letterhead paper) shall be signed with a legally
binding signature (e.g.\ blue ink or digitally) by the institution's legal representative
indicating their name, function, email address and, in case of blue ink signature, along
with the stamp of the institution.}

\textbf{The \erccomment{<<please fill in here the name of the legal entity that is
associated to the proposal and may host the principal investigator and the project
(action) in case the application is successful>>}, which is the applicant legal entity,}
...
\begin{itemize}
    ...
    \item in the case of an ERC Plus Grant at least 30\% of her/his working time to the
    ERC-funded project (action) and spend at least 50\% of her/his working time in an EU
...
\ercentry{Email and legally binding signature of legal representative}
...
\textbf{\textcolor{red}{If the letter is digitally signed, please do NOT lock it. Locked
files cannot be uploaded to the submission portal}}
}}
